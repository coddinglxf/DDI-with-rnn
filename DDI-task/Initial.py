...
class Initial(object):
    def __init__(self,
        ...
        self.pre_trained = self.init_word_embedding(filename=self.pre_trained_embedding)
    ...
    def init_word_embedding(self, filename):
        ...
        for line in openfile:
            ...
            word_2_vector[words[0]] = [float(words[i]) for i in range(1, len(words))]
        openfile.close()
